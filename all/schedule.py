...
parser.add_option("-p", "--policy", default="RR", help="sched policy to use: SJF, FIFO, RR",
...
if options.solve == True:
    ...
    if options.policy == 'FIFO':
        ...
        # 2012080059 2012011321
        for job in joblist:
            print ("[ time   %d ] Run job %d for %.2f secs ( DONE at %.2f)"%(thetime, job[0], job[1], thetime + job[1]))
            thetime += job[1]
        print '\nFinal statistics:'
        t     = 0.0
        count = 0
